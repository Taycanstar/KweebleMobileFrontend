...
import FrequencyRepeat from '../../components/FrequencyRepeat';
...
const CustomRepeat = props => {
  ...
  const [frequencyText, setFrequencyText] = useState('Daily');
  const [isFrequencyVisible, setIsFrequencyVisible] = useState(false);
  const [isEveryVisible, setIsEveryVisible] = useState(false);
  ...
  const changeEveryVisible = bool => {
    setIsEveryVisible(bool);
  };
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            <Text style={{color: 'black', marginRight: 3}}>{frequency}</Text>
        ...
        <TouchableOpacity
          ...
          <TouchableOpacity
            onPress={() => setIsEveryVisible(true)}
            style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text
              style={{
                color: 'black',
      ...
      {/* <Modal
        visible={isEveryVisible}
        transparent
        onRequestClose={() => setIsEveryVisible(false)}> */}
      <Picker
        selectedValue={every}
        onValueChange={(itemValue, itemIndex) => {
          setEvery(itemValue == '1' ? '' : itemValue);
          setIsDay(itemValue == '1' ? 'Day' : 'Days');
        }}>
      ...
      <Modal
        ...
        transparent
        animationType="slide"
        onRequestClose={() => setIsFrequencyVisible(false)}>
        <TouchableOpacity
          style={{flex: 1}}
          onPress={() => setIsFrequencyVisible(false)}
          activeOpacity={1}>
          <FrequencyRepeat
            changeFrequencyVisible={changeFrequencyVisible}
            setFrequency={e => {
              setFrequencyText(e);
              setFrequency(e);
            }}
